...
export class UsermanagementListController {
     ...
     * @ngInject
     */
    constructor($state, $cookies, $resource, usermanagementList, kdUsermanagementListResource, $mdDialog, toastr) {
        /** @export  */
    ...
    $onInit() {
        if (this.cookies.get("username") != "admin") {
            this.state.go("release", { "namespace": this.cookies.get("username") });
        }
    }
}