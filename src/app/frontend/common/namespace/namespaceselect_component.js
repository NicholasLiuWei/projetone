...
export class NamespaceSelectController {
  ...
  formatNamespace() {
    ...
    if (namespace === ALL_NAMESPACES) {
      ...
      return this.i18n.MSG_DEFAULT_NAMESPACES;
    } else{
      return namespace;
    }
  }
...
const i18n = {
  ...
  /** @export {string} @desc Text for dropdown item that indicates that default namespace was selected */
  MSG_DEFAULT_NAMESPACES: goog.getMsg('default'),
